// Command processor will become the persistence consumer and windowed
// stream-processing / anomaly-detection stage (Phases 2-3). For now it
// establishes the service skeleton: config, structured logging, a
// /healthz endpoint, and graceful shutdown.
package main
