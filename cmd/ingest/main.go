// Command ingest will become the MQTT-to-NATS JetStream bridge (Phase 2).
// For now it establishes the service skeleton: config, structured logging,
// a /healthz endpoint, and graceful shutdown.
package main
