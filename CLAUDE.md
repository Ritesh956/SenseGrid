...
**Current status: Phases 0–2 complete** (tags `v0.1-phase0`, `v0.2-phase1`, `v0.3-phase2`). Phase 3
(windowed stream processing + anomaly detection) is next. See "Phase status" below before assuming
...
| 3 — Stream processing & anomaly detection | *(not started)* | Windowed stats (Welford's), EWMA, z-score/rate-of-change/silence detectors, alert state machine. |
